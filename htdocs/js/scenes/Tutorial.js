export default class Tutorial extends Phaser.Scene {
    ...
    collect(player, collectable) {
        ...
        else if (collectable.texture.key == "hearts" && this.heartscounter != 2) {
    ...
    update() {
        if (this.player.y > this.spawnpoint.y + 150 && this.heartscounter == 2) {
            this.heartscounter = 1;
            this.hearts.setFrame(0);
            this.player.x = this.spawnpoint.x;
            this.player.y = this.spawnpoint.y;
        }
        else if (this.player.y > this.spawnpoint.y + 150 && this.heartscounter == 1) {
            this.player.x = this.spawnpoint.x;
            this.player.y = this.spawnpoint.y;
        }
        this.jumpcounter++;
        ...
        if (this.cursors.left.isDown || this.keyA.isDown) {
            ...
            if (this.Distancecounter > 0) {
                this.Distancecounter = this.Distancecounter - 0.0125;
        ...
        if (this.Distancecounter < 1.5) {
        ...
        else if (this.Distancecounter < 12) {
            ...
            this.Tutorialsubtitletext.setVisible(false);
